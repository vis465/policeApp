...
import 'package:policeappp/screens/forms/view_forms.dart';

import '../../screens/forms/edit_forms.dart';
import '../../screens/forms/new_forms.dart';
import '../../screens/login.dart';
import '../admin/profile.dart';
import '../admin/totalCount.dart';
import 'fieldofficerprofile.dart';

class fieldOfficerScaffold extends StatefulWidget {
  const fieldOfficerScaffold({Key? key}) : super(key: key);

  @override
  State<fieldOfficerScaffold> createState() => _fieldOfficerScaffoldState();
}

class _fieldOfficerScaffoldState extends State<fieldOfficerScaffold> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(child: fieldOfficerHome()),
    );
  }
}

class fieldOfficerHome extends StatefulWidget {
  const fieldOfficerHome({Key? key}) : super(key: key);
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => fieldofficerprofileScaffold()));
                      },
                      child: Column(
                        children: <Widget>[
                          Icon(
              ...
              SizedBox(
                ...
                child: DialogButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => newFormsScaffold()),
                    );
                  },
                ),
              ),
              ...
              SizedBox(
                ...
                child: DialogButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => editFormsScaffold()),
                    );
                  },
                ),
              ),
